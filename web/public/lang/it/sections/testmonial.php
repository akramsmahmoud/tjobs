      ...
      <div id="owl-testi" class="owl-carousel owl-theme">
          <div class="item">
            <div  class="col-md-10 col-md-offset-1"> <img src="images/Testimonials/02.jpg" class="img-circle" alt="">
              <h5>Un modo così semplice per navigare e per contattare facilmente gli impiegati</h5>
              <h6>John Doe</h6>
              <p>CEO</p>
            </div>
          </div>
          <div  class="col-md-10 col-md-offset-1"> <img src="images/Testimonials/03.jpg" class="img-circle" alt="">
            <h5>che desin ragazzi congratulazione e vai avanti</h5>
            <h6>SAM DEEN</h6>
            <p>Web Designer</p>
          </div>
          <div  class="col-md-10 col-md-offset-1"> <img src="images/Testimonials/04.jpg" class="img-circle" alt="">
            <h5>Ho avuto una buona esperienza nell'invio del modulo e trovare un buon impiegato</h5>
            <h6>EMA JOHNSON</h6>
            <p>Human Resource</p>
          </div>
        </div>
